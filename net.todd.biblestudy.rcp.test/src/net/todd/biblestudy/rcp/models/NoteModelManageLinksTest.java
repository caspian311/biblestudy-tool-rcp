...
public class NoteModelManageLinksTest
{
	...
	@Test
	public void testLinksShiftRightWhenContentAddedBeforeLink() throws Exception
	{
		List<NoteStyle> noteStyles = noteModel.getNoteStylesForRange(0, 100);
		assertEquals(0, noteStyles.size());
	...
	@Test
	public void testLinksShiftsLeftWhenContentRemovedBeforeLink() throws Exception
	{
