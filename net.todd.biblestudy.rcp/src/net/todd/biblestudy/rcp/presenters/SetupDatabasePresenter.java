...
public class SetupDatabasePresenter {
	...
	public SetupDatabasePresenter(ISetupDatabaseView view,
			ISetupDatabaseModel model) {
		this.view = view;
		this.model = model;
	}
	...
	public boolean setup() {
		...
		try {
			...
			ExceptionHandlerFactory
					.getHandler()
					.handle("An error occurred while trying to initialize the database.",
							this, e, SeverityLevel.FATAL);
		}
