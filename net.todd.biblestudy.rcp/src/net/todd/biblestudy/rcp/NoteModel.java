...
public class NoteModel extends AbstractMvpEventer implements INoteModel {
	...
	private Point rightClickedCooardinates;
	...
	public void save() {
		...
		notifyListeners(CONTENT_CHANGED);
	}
	...
	@Override
	public void setRightClickedCooardinates(Point rightClickedCooardinates) {
		this.rightClickedCooardinates = rightClickedCooardinates;
	}

	@Override
	public Point getRightClickCoordinates() {
		return rightClickedCooardinates;
	}
}
