...
public class DefaultExceptionHandler extends ExceptionHandler {
	...
	private void popupErrorMessage(String message, Throwable t, SeverityLevel severityLevel) {
		...
		ErrorDialog dialog = new ErrorDialog(Display.getDefault().getActiveShell(), dialogTitle, message, status,
				IStatus.ERROR);
		dialog.open();
	}

	private void logException(String message, Object origin, Throwable t, SeverityLevel severityLevel) {
