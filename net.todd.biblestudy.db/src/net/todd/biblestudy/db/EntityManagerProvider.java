...
public class EntityManagerProvider {
	...
	public static EntityManager getEntityManager(boolean createDatabase) {
		try {
			return new EntityManager(new DerbyDatabaseProvider(getDatabaseUri(createDatabase), "", ""));
		} catch (Exception e) {
			LOG.error(e);
	...
	private static String getDatabaseUri(boolean createDatabase) {
	...
	public static Connection getConnection() {
		try {
			return new DerbyDatabaseProvider(getDatabaseUri(true), "", "").getConnectionImpl();
		} catch (Exception e) {
			LOG.error(e);
			throw new RuntimeException(e);
		}
